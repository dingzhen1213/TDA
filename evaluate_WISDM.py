...
from utils.WISDM_utils.mertrics import evaluate_model, print_detailed_metrics, print_confusion_matrix
...
def evaluate_model_with_analysis(model, test_loader, device, label_encoder,
                                 model_path="save/WISDM/checkpoints/tdn_wisdm_best.pth"):
    ...
    cm = print_detailed_metrics(y_true, y_pred, label_encoder)

    # Print confusion matrix in readable format
    print_confusion_matrix(cm, label_encoder)
