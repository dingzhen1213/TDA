...
class TDN_UCI(nn.Module):
    """Temporal Decomposition Network for UCI-HAR"""

    def __init__(self, window_size=128, input_channels=9, num_classes=6,
        ...
        self.trend_attention = TemporalDecomposedAttention(
            ...
            freq_bins=min(32, window_size // 2 + 1), dropout=0.1
        )
